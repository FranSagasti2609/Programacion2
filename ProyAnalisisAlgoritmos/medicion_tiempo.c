...
#include <stdlib.h>
 ...
 /* 1. Calcular la suma de los primeros N números enteros positivos. Se pide implementar un 
  ...
  /* 2. Encontrar el mínimo valor en un arreglo de N elementos. Se pide implementar un algoritmo que    reciba como entrada un arreglo de tamaño N y devuelva el valor mínimo contenido en el arreglo.
